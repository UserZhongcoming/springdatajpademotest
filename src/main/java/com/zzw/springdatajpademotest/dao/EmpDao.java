package com.zzw.springdatajpademotest.dao;
...
//    -- 3. 选择工资不在500到1200的员工的姓名和工资
    public List<Emp> findBySalLessThanOrSalGreaterThan(BigDecimal min,
            BigDecimal max);
...
//    -- 9. 选择员工姓名的第三个字母是a的员工姓名
    ...
    public List<Object[]> findByEname(String str);
//    -- 10. 选择姓名中有字母a和e的员工姓名
//    @Query("select e.ename from Emp e where ename")
//    public List<Object[]> findByEnameContains(String str1, String str2);
